...
import { Search, Heart, User, ShoppingCart, Globe, Menu, X, ChevronDown } from 'lucide-react'
      ...
      <header className={`main-navbar ${scrolled ? 'scrolled' : ''}`}>
        <div className="navbar-container">
          ...
          <div className="navbar-right">
            <NavLink to="/app/orders" className="nav-icon-btn" title="My Orders">
      ...
      {mobileMenuOpen && (
        <nav className="mobile-nav">
          <div className="mobile-nav-section">
            <h4>Menu</h4>
            <NavLink to="/app" onClick={() => setMobileMenuOpen(false)}>Home</NavLink>
            <NavLink to="/app/search" onClick={() => setMobileMenuOpen(false)}>Explore Services</NavLink>
            <NavLink to="/app/orders" onClick={() => setMobileMenuOpen(false)}>My Orders</NavLink>
            <NavLink to="/app/saved" onClick={() => setMobileMenuOpen(false)}>Saved Services</NavLink>
            <NavLink to="/app/profile" onClick={() => setMobileMenuOpen(false)}>Profile</NavLink>
          </div>
          <div className="mobile-nav-section">
            <h4>Categories</h4>
            {categories.map(cat => (
